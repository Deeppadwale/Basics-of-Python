...
# list sort,copy and some operations
# sort() is a method to use print the list desending and undesending format 




new_salary=[x for x in salary_list if isinstance(x,(int,float))]
xeeee=[y for y in new_salary if y > 1000 ]
print(new_salary)
# new_salary.sort()
new_salary.reverse()
print(new_salary)
